...
namespace ScreenTransferProgram
{
    class ScreenCapture
    {
        public const long SCREEN_CAPTURE_QUALITY = 50L; // 화면 캠쳐 이미지의 화질
        ...
        /// <summary>
        /// 캡쳐한 화면 이미지의 byte 배열로 변환
        /// </summary>
        /// <returns>캡처한 화면 이미지의 byte 배열</returns>
